...
public class GoingOTManager_sk : MonoBehaviour
{
    private CinemachineVirtualCamera cmCamera;    
    public TalkManager_goot_sk talkManager;
    ...
    public void questionMark1(){
        ...
        talkText2.text = "AI 공학관으로 이동해 신입생 오리엔테이션에 참석하세요.";       
    }
    ...
    public void noneMudang(){
        var heemudangAction = heemudang.GetComponent<MudangAction_goot_sk>();
        Vector3 pos2;
