...
public class heeTalkManager : MonoBehaviour
{
   ...
   void GenerateData(){
      ...
      //talkname
       ...
       //Quest_1 1월  intro    
       talkData.Add(10+ 1000, new string[] {"잘 찾아왔어!!:2","AI공학관 앞에 가서 선배님께 인사드려!!:0","화면 왼쪽의 버튼을 누르면, 전체맵과 현재 위치를 알 수 있어!!:2","오른쪽 상단의 설정버튼을 통해 음량조절, 저장, 종료를 진행할 수 있어~~^^:0","무당이를 타면 더 빠르게 갈 수 있어!!!:2", "건물 앞에서 건물 이름을 알 수 있어!!!:0"});
       talkData.Add(11+ 2000, new string[] {"오 왔니? 나는 1년전에 입학했어~:2","매 선택지마다 얻을 수 있는 능력치가 다르더라~ 능력치를 잘 쌓아봐!!!:2", "앞으로 학교 생활에 도움을 줄게!!:0", "가천대 컴퓨터공학과에 온걸 진심으로 환영해!!:2","옆에 교수님께 인사드려!:0"});
       talkData.Add(12+ 8000, new string[] {"허허 신입생이군요:1","매 달마다 수업이 있어요~:0","4월에는 중간고사, 6월에는 기말고사를 치를거예요~:1","6월에 종강하면 성적표가 나옵니다~~:1", "앞으로 4학년동안 열심히 공부해서 꿈을 이루길 바라요~:0","2월에 OT에서 다시 만나요~:1"}); //이후에 2월 OT씬 진행(방에서)
