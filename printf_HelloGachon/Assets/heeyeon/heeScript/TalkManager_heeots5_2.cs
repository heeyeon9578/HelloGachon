...
public class TalkManager_heeots5_2 : MonoBehaviour
{
    ...
    void generateData()
    {
       ...
       //시작할때 intro 대사 , 튜토리얼, npc들 익히기
        talkData.Add(3000, new string[] {"6월 마지막 수업 잘 들으셨나요???:1",
                                        "이제 기말고사 보고, 종강합시다~~ 마지막까지 화이팅!!!!! :1",
                                        "1학년의 마지막 시험이다!!!!! 가자!!!!!!!! 아자!!!!!!:2"                                     
                                        });
        ...
        talkData.Add(10 + 800, new string[] { "기말고사 보러가자!!!!!" });
