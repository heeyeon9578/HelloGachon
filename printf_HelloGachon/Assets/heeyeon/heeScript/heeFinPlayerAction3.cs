...
public class heeFinPlayerAction3 : MonoBehaviour
{
    public heeFinManager3 dManager;
    ...
    {
        //수평, 수직 이동 변수
        h = (dManager.isInteract || dManager.objectDetect || qManager.isInteract || qManager.isChoosing) ? 0 : rightValue+leftValue;
        v = (dManager.isInteract || dManager.objectDetect || qManager.isInteract || qManager.isChoosing) ? 0 : upValue+downValue;

        bool hDown = (dManager.isInteract || dManager.objectDetect || qManager.isInteract || qManager.isChoosing) ? false : rightDown||leftDown;
        bool vDown = (dManager.isInteract || dManager.objectDetect || qManager.isInteract || qManager.isChoosing) ? false : upDown||downDown;
        bool hUp = (dManager.isInteract || dManager.objectDetect || qManager.isInteract || qManager.isChoosing) ? false : rightUp||leftUp;
        bool vUp = (dManager.isInteract || dManager.objectDetect || qManager.isInteract || qManager.isChoosing) ? false : upUp||downUp;
