...
public class TalkManager_heeots5 : MonoBehaviour
{
    ...
    void generateData()
    {
       ...
       //시작할때 intro 대사 , 튜토리얼, npc들 익히기
        talkData.Add(3000, new string[] {"다들 한마음 페스티벌은 재밌었나요?:1",
                                        "재밌게 놀았으니, 이제 5월 수업을 들으러 오세요~~:1",
                                        "으아, 수업 들으러 가야겠네:2"                                     
                                        });
        ...
        talkData.Add(10 + 800, new string[] { "수업 들으러 가볼까~" });
